...
And you might dismiss me as another "AI bro", but this mindset is completely new to me. I genuinely didn't believe a fully automated SOC was feasible until earlier this week. Now I not only believe it's possible, I believe it will arrive much faster than most people expect.
...
Like examining the command line output of a running process to determine if it was malicious, analyzing executed PowerShell scripts, understanding the sentiment of email bodies to detect social engineering attempts, suppressing false positive alerts, and more.
